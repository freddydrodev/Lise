<ul class="navbar-nav w-100 justify-content-end align-items-center">
  ...
  <li class="nav-item mr-4" data-toggle="tooltip" data-placement="bottom" title="Employees">
    <a href="<?php echo $_ind ?>EmployeesIndex.php" class="nav-link <?php echo $page == 'Employees' ? 'active' : '' ?>">
  ...
  <li class="nav-item mr-4" data-toggle="tooltip" data-placement="bottom" title="Clients">
    <a href="<?php echo $_ind ?>CustomersIndex.php" class="nav-link <?php echo $page == 'Clients' ? 'active' : '' ?>">
  ...
  <li class="nav-item mr-4" data-toggle="tooltip" data-placement="bottom" title="Produits">
    <a href="<?php echo $_ind ?>ProductsIndex.php" class="nav-link <?php echo $page == 'Produits' ? 'active' : '' ?>">
  ...
  <li class="nav-item mr-4" data-toggle="tooltip" data-placement="bottom" title="Commandes">
    <a href="<?php echo $_ind ?>OrdersIndex.php" class="nav-link <?php echo $page == 'Commandes' ? 'active' : '' ?>">
  ...
  <li class="nav-item mr-4" data-toggle="tooltip" data-placement="bottom" title="Ventes">
    <a href="<?php echo $_ind ?>SalesIndex.php" class="nav-link <?php echo $page == 'Ventes' ? 'active' : '' ?>">
  ...
  <li class="nav-item">
    <a href="<?php echo $_ind ?>Logout/Index.php" class="nav-link" data-toggle="tooltip" data-placement="left" title="Deconnexion">
